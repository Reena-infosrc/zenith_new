...
import MonthlyRmFeedbackSession from "./pages/MonthlyRmFeedbackSession";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/performance/monthly-rm-feedback" element={<RequireAuth><MonthlyRmFeedbackSession /></RequireAuth>} />
